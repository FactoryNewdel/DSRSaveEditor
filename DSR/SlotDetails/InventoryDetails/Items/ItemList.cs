...
public class ItemList
{
    private static readonly List<Item> _items = new()
    {
        ...
        // Spells   3XXX
        // Sorceries
        new Spell(ItemType.SoulArrow,                   64,     3000,   0x00BB90, 30),
        new Spell(ItemType.GreatSoulArrow,              64,     3010,   0x00BBA0, 20),
        new Spell(ItemType.HeavySoulArrow,              64,     3020,   0x00BBB0, 12),
        new Spell(ItemType.GreatHeavySoulArrow,         64,     3030,   0x00BBC0,  8),
        new Spell(ItemType.HomingSoulmass,              64,     3040,   0x00BBD0, 10),
        new Spell(ItemType.HomingCrystalSoulmass,       64,     3050,   0x00BBE0, 10),
        new Spell(ItemType.SoulSpear,                   64,     3060,   0x00BBF0,  4),
        new Spell(ItemType.CrystalSoulSpear,            64,     3070,   0x00BC00,  4),
        new Spell(ItemType.MagicWeapon,                 64,     3100,   0x00BC20,  5),
        new Spell(ItemType.GreatMagicWeapon,            64,     3110,   0x00BC30,  3),
        new Spell(ItemType.CrystalMagicWeapon,          64,     3120,   0x00BC40,  3),
        new Spell(ItemType.MagicShield,                 64,     3300,   0x00BC50,  5),
        new Spell(ItemType.StrongMagicShield,           64,     3310,   0x00BC60,  3),
        new Spell(ItemType.HiddenWeapon,                64,     3400,   0x00BCA0,  3),
        new Spell(ItemType.HiddenBody,                  64,     3410,   0x00BCB0,  3),
        new Spell(ItemType.CastLight,                   64,     3500,   0x00BCD0,  3),
        new Spell(ItemType.Hush,                        64,     3510,   0x00BC80,  6),
        new Spell(ItemType.AuralDecoy,                  64,     3520,   0x00BC70, 20),
        new Spell(ItemType.Repair,                      64,     3530,   0x00BCC0,  1),
        new Spell(ItemType.FallControl,                 64,     3540,   0x00BC90, 10),
        new Spell(ItemType.Chameleon,                   64,     3550,   0x00BCE0, 11),
        new Spell(ItemType.ResistCurse,                 64,     3600,   0x00BD00,  4),
        new Spell(ItemType.Remedy,                      64,     3610,   0x00BCF0,  4),
        new Spell(ItemType.WhiteDragonBreath,           64,     3700,   0x00BC10, 20),
        
        // Pyromancies
        new Spell(ItemType.Fireball,                    64,     4000,   0x00BD50,  8),
        new Spell(ItemType.FireOrb,                     64,     4010,   0x00BD60,  6),
        new Spell(ItemType.GreatFireball,               64,     4020,   0x00BD70,  4),
        new Spell(ItemType.Firestorm,                   64,     4030,   0x00BD90, 20),
        new Spell(ItemType.FireTempest,                 64,     4040,   0x00BDA0, 20),
        new Spell(ItemType.FireSurge,                   64,     4050,   0x00BDE0, 20),
        new Spell(ItemType.FireWhip,                    64,     4060,   0x00BDF0, 80),
        new Spell(ItemType.Combustion,                  64,     4100,   0x00BDC0, 16),
        new Spell(ItemType.GreatCombustion,             64,     4110,   0x00BDD0,  8),
        new Spell(ItemType.PoisonMist,                  64,     4200,   0x00BE10,  3),
        new Spell(ItemType.ToxicMist,                   64,     4210,   0x00BE20,  1),
        new Spell(ItemType.AcidSurge,                   64,     4220,   0x00BE30,  2),
        new Spell(ItemType.IronFlesh,                   64,     4300,   0x00BE50,  3),
        ...
        new Spell(ItemType.Homeward,                    64,     5210,   0x00BF40,  1),
        new Spell(ItemType.Force,                       64,     5300,   0x00BEF0, 21),
        new Spell(ItemType.WrathOfTheGods,              64,     5310,   0x00BF00,  3),
        new Spell(ItemType.EmitForce,                   64,     5320,   0x00BF10,  6),
