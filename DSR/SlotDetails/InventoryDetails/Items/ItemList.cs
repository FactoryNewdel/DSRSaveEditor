...
public class ItemList
{
    private static readonly List<Item> _items = new()
    {
        ...
        new Weapon(ItemType.GreatswordOfArtoriasCursedBanditsKnife,             0,      311200, 0x008340,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedShortSword,               0,      311300, 0x027740,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedLongSword,                0,      311400, 0x02B5C0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedBroadSword,               0,      311500, 0x02F440,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedBalderSideSword,          0,      311600, 0x0332C0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedSunlightStraightSword,    0,      311700, 0x037140,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedBarbedStraightSword,      0,      311800, 0x042CC0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedDarkSword,                0,      312000, 0x03EE40,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedBastardSword,             0,      312100, 0x075940,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedClaymore,                 0,      312200, 0x0797C0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedManserpentGreatsword,     0,      312300, 0x07D640,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedFlamberge,                0,      312400, 0x0814C0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedZweihander,               0,      312500, 0x0C79C0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedGreatsword,               0,      312600, 0x0C3B40,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatswordOfArtoriasCursedDemonGreatMachete,        0,      312700, 0x0CB840,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordDagger,                          0,      314000, 0x000640,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordParryingDagger,                  0,      314100, 0x0044C0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordBanditsKnife,                    0,      314200, 0x008340,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordShortSword,                      0,      314300, 0x027740,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordLongSword,                       0,      314400, 0x02B5C0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordBroadSword,                      0,      314500, 0x02F440,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordBalderSideSword,                 0,      314600, 0x0332C0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordSunlightStraightSword,           0,      314700, 0x037140,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordBarbedStraightSword,             0,      314800, 0x042CC0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordDarkSword,                       0,      315000, 0x03EE40,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordBastardSword,                    0,      315100, 0x075940,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordClaymore,                        0,      315200, 0x0797C0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordManserpentGreatsword,            0,      315300, 0x07D640,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordFlamberge,                       0,      315400, 0x0814C0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordZweihander,                      0,      315500, 0x0C79C0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordGreatsword,                      0,      315600, 0x0C3B40,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GreatLordGreatswordDemonGreatMachete,               0,      315700, 0x0CB840,       400,    WeaponUpgradeType.Demon),
        ...
        new Weapon(ItemType.QuelaagsFuryswordScimitar,                          0,      406000, 0x0EAC40,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.QuelaagsFuryswordFalchion,                          0,      406100, 0x0F0A00,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.QuelaagsFuryswordShotel,                            0,      406200, 0x0F2940,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.QuelaagsFuryswordPaintingGuardianSword,             0,      406300, 0x0F67C0,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.QuelaagsFuryswordServer,                            0,      406400, 0x115BC0,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.QuelaagsFuryswordMurakumo,                          0,      406500, 0x111D40,       600,    WeaponUpgradeType.Demon),
        ...
        new Weapon(ItemType.ChaosBladeUchigatana,                               0,      503000, 0x13CCC0,       120,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.ChaosBladeWashingPole,                              0,      503100, 0x140B40,       120,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.ChaosBladeIaito,                                    0,      503200, 0x13CCC0,       120,    WeaponUpgradeType.Demon),
        ...
        new Weapon(ItemType.GolemAxeHandAxe,                                    0,      704000, 0x187040,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GolemAxeBattleAxe,                                  0,      704100, 0x18AEC0,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GolemAxeButcherKnife,                               0,      704300, 0x18ED40,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GolemAxeGargoyleTailAxe,                            0,      704400, 0x192BC0,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.GolemAxeDemonsGreataxe,                             0,      704600, 0x1B1FC0,       600,    WeaponUpgradeType.Demon),
        ...
        new Weapon(ItemType.SmoughsHammerClub,                                  0,      856000, 0x1D3F80,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.SmoughsHammerMace,                                  0,      856100, 0x1DCF40,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.SmoughsHammerMorningStar,                           0,      856200, 0x1E0DC0,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.SmoughsHammerWarpick,                               0,      856300, 0x1E4C40,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.SmoughsHammerPickaxe,                               0,      856400, 0x1E8AC0,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.SmoughsHammerReinforcedClub,                        0,      856500, 0x1D5240,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.SmoughsHammerBlacksmithHammer,                      0,      856600, 0x1EC940,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.SmoughsHammerGreatClub,                             0,      856900, 0x2001C0,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.SmoughsHammerDemonsGreatHammer,                     0,      857000, 0x204040,       600,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.SmoughsHammerLargeClub,                             0,      857100, 0x1FC340,       600,    WeaponUpgradeType.Demon),
        ...
        new Weapon(ItemType.DragonslayerSpearSpear,                             0,      1051300,        0x223440,       300,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.DragonslayerSpearWingedSpear,                       0,      1051400,        0x2272C0,       300,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.DragonslayerSpearPartizan,                          0,      1051500,        0x22B140,       300,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.DragonslayerSpearPike,                              0,      1051800,        0x3B9840,       300,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.MoonlightButterflyHornMailBreaker,                  0,      1052000,        0x15FF40,       160,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.MoonlightButterflyHornRapier,                       0,      1052100,        0x163DC0,       160,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.MoonlightButterflyHornEstoc,                        0,      1052200,        0x167C40,       160,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.MoonlightButterflyHornRicardsRapier,                0,      1052900,        0x16BAC0,       160,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.MoonlightButterflyHornSpear,                        0,      1052300,        0x223440,       160,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.MoonlightButterflyHornWingedSpear,                  0,      1052400,        0x2272C0,       160,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.MoonlightButterflyHornPartizan,                     0,      1052500,        0x22B140,       160,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.MoonlightButterflyHornPike,                         0,      1052800,        0x3B9840,       160,    WeaponUpgradeType.Demon),
        ...
        new Weapon(ItemType.LifehuntScytheScythe,                               0,      1151200,        0x252240,       100,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.LifehuntScytheGargoylesHalberd,                     0,      1151400,        0x2560C0,       100,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.LifehuntScytheGreatScythe,                          0,      1151500,        0x271640,       100,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.LifehuntScytheWhip,                                 0,      1151600,        0x298740,       100,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.LifehuntScytheNotchedWhip,                          0,      1151700,        0x29C5C0,       100,    WeaponUpgradeType.Demon),
        ...
        new Weapon(ItemType.DarkmoonBowShortBow,                                0,      1205000,        0x2BF840,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.DarkmoonBowLongBow,                                 0,      1205200,        0x2C7540,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.DarkmoonBowBlackBowOfPharis,                        0,      1205300,        0x2CB3C0,       400,    WeaponUpgradeType.Demon),
        new Weapon(ItemType.DarkmoonBowCompositeBow,                            0,      1205100,        0x2C36C0,       400,    WeaponUpgradeType.Demon),
        ...
        new Weapon(ItemType.CrystalRingShieldEastWestShield,                    0,      1411000,        0x382D40,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldWoodenShield,                      0,      1411100,        0x386BC0,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldLargeLeatherShield,                0,      1411300,        0x38AA40,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldSmallLeatherShield,                0,      1411400,        0x3483C0,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldTargetShield,                      0,      1411600,        0x353F40,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldBuckler,                           0,      1411700,        0x3500C0,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldCrackedRoundShield,                0,      1411800,        0x341340,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldLeatherShield,                     0,      1411500,        0x34C240,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldPlankShield,                       0,      1411200,        0x344540,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldCaduceusRoundShield,               0,      1411900,        0x3389C0,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldHeaterShield,                      0,      1412000,        0x38E8C0,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldKnightShield,                      0,      1412100,        0x39E2C0,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldTowerKiteShield,                   0,      1412200,        0x392740,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldGrassCrestShield,                  0,      1412300,        0x3A9E40,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldHollowSoldierShield,               0,      1412400,        0x39A440,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldBalderShield,                      0,      1412500,        0x3A2DC0,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldWarriorsRoundShield,               0,      1412600,        0x334B40,       120,    WeaponUpgradeType.ShieldDemon),
        ...
        new Weapon(ItemType.CrystalRingShieldGargoylesShield,                   0,      1413400,        0x3BD6C0,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldEagleShield,                       0,      1413500,        0x3F8040,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldTowerShield,                       0,      1413600,        0x3FBEC0,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldGiantShield,                       0,      1413700,        0x4009C0,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldBonewheelShield,                   0,      1413800,        0x403BC0,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldEffigyShield,                      0,      1413900,        0x33C840,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldSanctus,                           0,      1414000,        0x3A0840,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldBloodshield,                       0,      1414100,        0x3AC3C0,       120,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.CrystalRingShieldBlackIronGreatshield,              0,      1414200,        0x3FE440,       120,    WeaponUpgradeType.ShieldDemon),
        ...
        new Weapon(ItemType.GreatshieldOfArtoriasEastWestShield,                0,      1507000,        0x382D40,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasWoodenShield,                  0,      1507100,        0x386BC0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasLargeLeatherShield,            0,      1507300,        0x38AA40,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasSmallLeatherShield,            0,      1507400,        0x3483C0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasTargetShield,                  0,      1507600,        0x353F40,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasBuckler,                       0,      1507700,        0x3500C0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasCrackedRoundShield,            0,      1507800,        0x341340,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasLeatherShield,                 0,      1507500,        0x34C240,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasPlankShield,                   0,      1507200,        0x344540,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasCaduceusRoundShield,           0,      1507900,        0x3389C0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasHeaterShield,                  0,      1508000,        0x3A5FC0,       600,    WeaponUpgradeType.ShieldDemon), //
        new Weapon(ItemType.GreatshieldOfArtoriasKnightShield,                  0,      1508100,        0x39E2C0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasTowerKiteShield,               0,      1508200,        0x392740,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasGrassCrestShield,              0,      1508300,        0x3A9E40,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasHollowSoldierShield,           0,      1508400,        0x39A440,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasBalderShield,                  0,      1508500,        0x3A2DC0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasWarriorsRoundShield,           0,      1508600,        0x334B40,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasIronRoundShield,               0,      1508700,        0x3AE940,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasSpiderShield,                  0,      1508800,        0x3A5FC0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasSpikedShield,                  0,      1508900,        0x3B9840,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasSunlightShield,                0,      1509100,        0x3B1B40,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasPierceShield,                  0,      1509000,        0x3B59C0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasRedandWhiteRoundShield,        0,      1509200,        0x33EDC0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasCaduceusKiteShield,            0,      1509300,        0x3965C0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasGargoylesShield,               0,      1509400,        0x3BD6C0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasEagleShield,                   0,      1509500,        0x3F8040,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasTowerShield,                   0,      1509600,        0x3FBEC0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasGiantShield,                   0,      1509700,        0x4009C0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasBonewheelShield,               0,      1509800,        0x403BC0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasEffigyShield,                  0,      1509900,        0x33C840,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasSanctus,                       0,      1510000,        0x3A0840,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasBloodshield,                   0,      1510100,        0x3AC3C0,       600,    WeaponUpgradeType.ShieldDemon),
        new Weapon(ItemType.GreatshieldOfArtoriasBlackIronGreatshield,          0,      1510200,        0x3FE440,       600,    WeaponUpgradeType.ShieldDemon),
        ...
        // DLC Weapon           90XXXXXX
        new Weapon(ItemType.AbyssGreatsword,                                    0,      9013000,        0x0C3B40,       300,    WeaponUpgradeType.Full),
        ...
        new Weapon(ItemType.ManusCatalyst,                                      0,      9017000,        0x30DA40,       300,    WeaponUpgradeType.ShieldTwinkling),
